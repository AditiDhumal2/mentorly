        ...
        <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          <div className="p-6">
            ...
            <div className="border-t pt-6">
              ...
              {/* Reply Form */}
              {currentUser ? (
                <form onSubmit={handleSubmitReply} className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <h4 className="text-lg font-semibold text-green-800 mb-3">
                    {post.visibility === 'students' ? '💬 Help This Student' : 'Post Your Reply as Mentor'}
                  </h4>
                  <div className="mb-3">
                    <textarea
                      value={replyMessage}
                      ...
                      placeholder={post.visibility === 'students' 
                        ? "Share your expert advice to help this student..." 
                        : "Write your reply as a mentor..."}
                      required
                    />
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    >
                      {post.visibility === 'students' ? '🎯 Help Student' : 'Post Reply'}
                    </button>
                  </div>
                </form>
              ) : (
